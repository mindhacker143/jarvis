...
function App() {
  ...
  return (
    <>
      <div className='h-full w-screen bg-gradient-to-r from-sky-900 to-sky-700'>
        <NAVBAR></NAVBAR>
        <div className='flex '><div>  <GETSTARTED></GETSTARTED></div>
          <div><AI></AI></div></div>
        <div className='items-center justify-center flex '> <div className=' text-center flex  justify-center space-x-8 py-4  h-[1000px] w-[1080px] border-2  border-white  bg-gradient-to-r from-sky-900 to-sky-700 '>
          <div className='h-full w-screen bg-gradient-to-r from-sky-800 to-sky-500 shadow-2xl py-10 space-y-20'>
